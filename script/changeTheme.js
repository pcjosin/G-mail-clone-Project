function changeTheme(id){
    ...
    displayBody.style.backgroundImage=`url('http://127.0.0.1:5500/img/themes/${id}.jpg')`;
    ...
    document.getElementById("logo-icon").src="img/logo_gmail_lockup_dark_2x_r5.png"
...
function changeThemeDeafult(){
    ...
    document.getElementById("logo-icon").src="img/logo_gmail_lockup_default_1x_r5.png";
